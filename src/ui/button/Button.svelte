...
<style lang="less">
    button {
        ...
        --button-second-color: var(--accent_white);
        position: relative;
        padding: 0.5rem 1rem;
        font-family: inherit;
        font-weight: bold;
    ...
    .text {
        --button-second-color: var(--button-main-color);
        background: none;
...
<button type="button" class:text class:clicked={clicked} on:click={animateClick} on:click={forwardClick} {...$$restProps}>
    <slot></slot>
</button>
